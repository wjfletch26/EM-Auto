...
You are rewriting one step in a 12-step sequence during an automatic QC repair round.

You MUST return valid JSON only: `{"subject":"...","body":"..."}`.

## Instruction Priority (highest to lowest)
1. Hard rules / compliance constraints
2. QC remediation for this step
3. David project notes (context only)
4. Original email + sequence context
...
- Follow the step purpose and CTA intent for this step unless QC issues require a change.
...
## QC remediation for this step (mandatory fixes)
{{qc_remediation}}

## David project notes (context only)
{{david_project_notes}}

Rewrite only this step. Preserve purpose and CTA unless remediation requires change.
